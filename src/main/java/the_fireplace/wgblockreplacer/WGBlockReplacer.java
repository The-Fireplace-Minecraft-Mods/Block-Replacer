...
@Mod(modid = WGBlockReplacer.MODID, name = WGBlockReplacer.MODNAME, guiFactory = "the_fireplace.wgblockreplacer.config.WGBRGuiFactory", canBeDeactivated = true, updateJSON = "http://thefireplace.bitnamiapp.com/jsons/wgblockreplacer.json", acceptedMinecraftVersions = "[1.12,1.13)", acceptableRemoteVersions = "*")
